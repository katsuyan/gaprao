"""
Django settings for gaprao project.
...
SECRET_KEY = 'wrgj@)=w%)v5tf9nk2f0ceflzbxj*snu(xj!mzbt4i1idbp493'
...
WSGI_APPLICATION = 'gaprao.wsgi.application'
...
LOGIN_REDIRECT_URL = '/jugyo/index'
LOGIN_URL = '/login/'
